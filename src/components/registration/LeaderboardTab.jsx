      ...
      <div className="glass-panel p-6 border-l-4 border-l-amber-500 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-zinc-400 mt-1">
            Ranked player performance matrix across {leaderboardData?.match_count || 27} official bracket matches. Powered by FLUX Impact Rating & HLTV 2.0. Default sort: Kills.
          </p>
        </div>
